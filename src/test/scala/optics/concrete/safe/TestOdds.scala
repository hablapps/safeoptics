...
class TestOdd extends FunSpec with Matchers{
  ...
  val fl1: More[Int,String,B::Nil[String],
    Done[Int,String,String=>B::Nil[String]]] = addOneMore(fl0)

  val fl2: More[Int,String,B::B::Nil[String],
    More[Int,String,String => B::B::Nil[String], 
      Done[Int,String,String => String => B::B::Nil[String]]]] = addOneMore(fl1)
      
  val fl3: More[Int,String,B::B::B::Nil[String]]
    More[Int,String,String => B::B::B::Nil[String],
      More[Int,String,String => String => B::B::B::Nil[String], 
        Done[Int,String,String => String => String => B::B::B::Nil[String]]]] = addOneMore(fl1)
